...
while True:
    pessoa=str(input("antes de começarmos,seu cliente é uma pessoa comum ou PM?(N/PM)")).upper()
...
def performace():
    ...
    if pessoa=="N":
        total2=somapp
        print("a soma deu {}".format(somapp))
    elif pessoa=="PM":
         total2=somapp*0.8
         print("a soma deu {}".format(somapp*0.8))
    return total2
...
def estetica():
    ...
    ptotal=str(input("o Veículo dele é nacional, importado ou do governo?(N,I,G")).upper()

    if ptotal=="N":
        total= soma2
        print("a soma das tunagens deu {}".format(soma2))

    elif ptotal=="I":
        total= soma2*1.5
        print("a soma das tunagens deu {}".format(soma2*1.5))

    elif ptotal=="G":
        total= soma2*0.8
        print("a soma das tunagens deu {}".format(soma2*0.8))
    return total

kit=int(input("Quantos kits?"))
pneu=int(input("Quantos Pneus?"))              
chave=int(input("Ele quis quantas chave(s) de roda?"))
macaco=int(input("e macaco hidráulico, quantos?"))
soma1=(kit*2500 + pneu*1500 + chave*2000 + macaco*2000)
if pessoa=="N":
    print("a soma deu {}".format(soma1))
elif pessoa=="PM":
    print("a soma deu {}".format(soma1*0.8))
